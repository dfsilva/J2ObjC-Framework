...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/serializer/SerializerBase.java
//
...
@interface OrgApacheXmlSerializerSerializerBase : NSObject < OrgApacheXmlSerializerSerializationHandler, OrgApacheXmlSerializerSerializerConstants > {
 ...
 by the referenced transformer object.
  ...
  /*!
   @brief The writer to send output to.
   This field is only used in the ToStream
 ...
 the current element.
   Such a frame is pushed at a startElement()
...
/*!
 @brief Add the given attributes to the currently collected ones.
 These
...
/*!
 @brief Return a <code>DOM3Serializer</code> interface into this serializer.
 If the
...
/*!
 @brief Flush and close the underlying java.io.Writer.
...
/*!
 @brief Returns the URI of an element or attribute.
 Note that default namespaces
...
/*!
 @brief Report the start element trace event.
 This trace method needs to be
...
/*!
 ...
 serializer.
 For historical reasons the serializer is flexible to
...
/*!
 ...
 Not a public API.
 */
inline NSString *OrgApacheXmlSerializerSerializerBase_get_PKG_NAME();
...
/*!
 ...
 Not a public API.
 */
inline NSString *OrgApacheXmlSerializerSerializerBase_get_PKG_PATH();
/*! INTERNAL ONLY - Use accessor function from above. */
