...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/sax2dtm/SAX2DTM.java
//
...
@interface OrgApacheXmlDtmRefSax2dtmSAX2DTM : OrgApacheXmlDtmRefDTMDefaultBaseIterators < OrgXmlSaxEntityResolver, OrgXmlSaxDTDHandler, OrgXmlSaxContentHandler, OrgXmlSaxErrorHandler, OrgXmlSaxExtDeclHandler, OrgXmlSaxExtLexicalHandler > {
 ...
 Made protected rather than private so SAX2RTFDTM can access it.
  ...
  jint m_textType_;
  /*!
   @brief Type of coalesced text block.
   See logic in the characters()
 method.
   */
  ...
  /*!
   @brief We are inside the DTD.
   This is used for ignoring comments.  
   */
...
/*!
 @brief Store the source location of the current node.
