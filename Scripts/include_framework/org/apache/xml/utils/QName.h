...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/utils/QName.java
//
...
/*!
 @brief Construct a QName from a string, without namespace resolution.
 Good
 for a few odd cases.
...
/*!
 ...
 Returns null if the namespace URI
 is not known.
...
inline jlong OrgApacheXmlUtilsQName_get_serialVersionUID();
 ...
 */
inline NSString *OrgApacheXmlUtilsQName_get_S_XMLNAMESPACEURI();
...
FOUNDATION_EXPORT OrgApacheXmlUtilsQName *new_OrgApacheXmlUtilsQName_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsQName *create_OrgApacheXmlUtilsQName_init();
