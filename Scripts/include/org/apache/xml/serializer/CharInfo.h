...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/serializer/CharInfo.java
//
...
/*!
 ...
 It also provides character to entity reference
 lookup.
...
@interface OrgApacheXmlSerializerCharInfo : NSObject {
 @public
  /*!
   @brief This flag is an optimization for HTML entities.
   It false if entities 
...
/*!
 @brief Map a character to a String.
 For example given
 ...
 */
inline NSString *OrgApacheXmlSerializerCharInfo_get_HTML_ENTITIES_RESOURCE();
...
/*!
 ...
 If specified, the file will be resource loaded with the default class loader.
 */
inline NSString *OrgApacheXmlSerializerCharInfo_get_XML_ENTITIES_RESOURCE();
/*! INTERNAL ONLY - Use accessor function from above. */
 ...
 */
inline jchar OrgApacheXmlSerializerCharInfo_get_S_HORIZONAL_TAB();
 ...
 */
inline jchar OrgApacheXmlSerializerCharInfo_get_S_LINEFEED();
 ...
 */
inline jchar OrgApacheXmlSerializerCharInfo_get_S_CARRIAGERETURN();
...
inline jchar OrgApacheXmlSerializerCharInfo_get_S_LINE_SEPARATOR();
...
/*!
 @brief Copy the first 0,1 ...
 ASCII_MAX values into an array 
 */
inline jint OrgApacheXmlSerializerCharInfo_get_ASCII_MAX();
