...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/serializer/dom3/NamespaceSupport.java
//
...
/*!
 @brief Namespace support for XML document handlers.
 This class doesn't 
...
@interface OrgApacheXmlSerializerDom3NamespaceSupport : NSObject {
 @public
  /*!
   @brief Namespace binding information.
   This array is composed of a
 ...
 as long as it is a power of 2 greater than 1.
  ...
  /*!
   @brief Context indexes.
   This array contains indexes into the namespace
...
inline NSString *OrgApacheXmlSerializerDom3NamespaceSupport_get_PREFIX_XML();
...
inline NSString *OrgApacheXmlSerializerDom3NamespaceSupport_get_PREFIX_XMLNS();
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 @brief The XML Namespace ("http://www.w3.org/XML/1998/namespace").
 This is
 the Namespace URI that is automatically mapped to the "xml" prefix.
 */
inline NSString *OrgApacheXmlSerializerDom3NamespaceSupport_get_XML_URI();
/*! INTERNAL ONLY - Use accessor function from above. */
 ...
 */
inline NSString *OrgApacheXmlSerializerDom3NamespaceSupport_get_XMLNS_URI();
/*! INTERNAL ONLY - Use accessor function from above. */
...
FOUNDATION_EXPORT OrgApacheXmlSerializerDom3NamespaceSupport *new_OrgApacheXmlSerializerDom3NamespaceSupport_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerDom3NamespaceSupport *create_OrgApacheXmlSerializerDom3NamespaceSupport_init();
