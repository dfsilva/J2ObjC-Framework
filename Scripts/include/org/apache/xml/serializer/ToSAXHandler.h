...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/serializer/ToSAXHandler.java
//
...
@interface OrgApacheXmlSerializerToSAXHandler : OrgApacheXmlSerializerSerializerBase {
 @public
  /*!
   @brief Underlying SAX handler.
   Taken from XSLTC
   */
  id<OrgXmlSaxContentHandler> m_saxHandler_;
  /*!
   @brief Underlying LexicalHandler.
   Taken from XSLTC
   */
...
/*!
 @brief Do nothing as this is an abstract class.
 All subclasses will need to
...
/*!
 @brief Does nothing.
 The setting of CDATA section elements has an impact on
 stream serializers.
