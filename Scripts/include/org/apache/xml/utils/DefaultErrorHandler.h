...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/utils/DefaultErrorHandler.java
//
...
@interface OrgApacheXmlUtilsDefaultErrorHandler : NSObject < OrgXmlSaxErrorHandler, JavaxXmlTransformErrorListener > {
 ...
 the error() and fatalError() methods.
   If it is false, the errors 
...
FOUNDATION_EXPORT OrgApacheXmlUtilsDefaultErrorHandler *new_OrgApacheXmlUtilsDefaultErrorHandler_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsDefaultErrorHandler *create_OrgApacheXmlUtilsDefaultErrorHandler_init();
...
FOUNDATION_EXPORT void OrgApacheXmlUtilsDefaultErrorHandler_printLocationWithJavaIoPrintWriter_withNSException_(JavaIoPrintWriter *pw, NSException *exception);
