...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/sax2dtm/SAX2RTFDTM.java
//
...
@interface OrgApacheXmlDtmRefSax2dtmSAX2RTFDTM : OrgApacheXmlDtmRefSax2dtmSAX2DTM {
 ...
 of NS elements.
   We can probabably reduce these to a single stack and save
 some storage.
   */
...
/*!
 @brief Given a DTM, find the owning document node.
 In the case of
...
/*!
 @brief Given a node identifier, find the owning document node.
 Unlike the DOM,
