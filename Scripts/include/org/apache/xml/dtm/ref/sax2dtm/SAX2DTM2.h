...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/sax2dtm/SAX2DTM2.java
//
...
/*!
 @brief Return the next namespace node following the given base node.
  The node identity of the base node, which can be an
...
/*!
 ...
 doing this.
 */
inline jint OrgApacheXmlDtmRefSax2dtmSAX2DTM2_get_TEXT_LENGTH_BITS();
...
inline jint OrgApacheXmlDtmRefSax2dtmSAX2DTM2_get_TEXT_OFFSET_BITS();
...
inline jint OrgApacheXmlDtmRefSax2dtmSAX2DTM2_get_TEXT_LENGTH_MAX();
...
inline jint OrgApacheXmlDtmRefSax2dtmSAX2DTM2_get_TEXT_OFFSET_MAX();
...
/*!
 @brief Iterator that returns the parent of a given node.
 Note that
...
@interface OrgApacheXmlDtmRefSax2dtmSAX2DTM2_PrecedingIterator : OrgApacheXmlDtmRefDTMDefaultBaseIterators_InternalAxisIteratorBase {
 ...
 which we must avoid.
   ...
   */
  jint _sp_, _oldsp_;
  jint _markedsp_, _markedNode_PrecedingIterator_, _markedDescendant_;
}
...
/*!
 ...
 The cloned iterator is not reset.
...
/*!
 ...
 given node.
 This includes the node set {root+1, start-1}, but
...
/*!
 @brief Tell if this node identity is a descendant.
 Assumes that
