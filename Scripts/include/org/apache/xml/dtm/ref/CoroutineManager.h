...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/CoroutineManager.java
//
...
@interface OrgApacheXmlDtmRefCoroutineManager : NSObject {
 ...
 in fact the one we intended to resume.
   Some such selection mechanism
...
/*!
 ...
 thing.
 We seem to need a way to achieve that same threadsafe
...
/*!
 @brief Terminate this entire set of coroutines.
 The others will be
...
/*!
 @brief Limit on the coroutine ID numbers accepted.
 I didn't want the
 ...
 this boundary.
  internal
 */
inline jint OrgApacheXmlDtmRefCoroutineManager_get_m_unreasonableId();
...
inline jint OrgApacheXmlDtmRefCoroutineManager_get_NOBODY();
...
inline jint OrgApacheXmlDtmRefCoroutineManager_get_ANYBODY();
...
FOUNDATION_EXPORT OrgApacheXmlDtmRefCoroutineManager *new_OrgApacheXmlDtmRefCoroutineManager_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlDtmRefCoroutineManager *create_OrgApacheXmlDtmRefCoroutineManager_init();
