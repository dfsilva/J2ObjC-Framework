...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/DTMDefaultBase.java
//
...
@interface OrgApacheXmlDtmRefDTMDefaultBase : NSObject < OrgApacheXmlDtmDTM > {
 ...
 (Efficiency hook)
  ...
  /*!
   @brief The document identity number(s).
   If we have overflowed the addressing
 range of the first that was assigned to us, we may add others. 
  ...
  /*!
   @brief The table for exandedNameID lookups.
...
/*!
 @brief A dummy routine to satisify the abstract interface.
 If the DTM
...
/*!
 ...
 @param namespace_ The namespace URI, which may be null, may be an empty
...
/*!
 @brief Given a node identity, return a node handle.
...
/*!
 @brief Given a node handle, return a node identity.
 If extended addressing
 has been used (multiple DTM IDs), we need to map the high bits of the
...
/*!
 ...
 active at this node.
 List is an SuballocatedIntVector whose
...
/*!
 @brief Add a node to the element indexes.
 The node will not be added unless
 it's an element.
...
inline jboolean OrgApacheXmlDtmRefDTMDefaultBase_get_JJK_DEBUG();
 ...
 */
inline jint OrgApacheXmlDtmRefDTMDefaultBase_get_ROOTNODE();
 ...
 */
inline jint OrgApacheXmlDtmRefDTMDefaultBase_get_DEFAULT_BLOCKSIZE();
 ...
 */
inline jint OrgApacheXmlDtmRefDTMDefaultBase_get_DEFAULT_NUMBLOCKS();
 ...
 */
inline jint OrgApacheXmlDtmRefDTMDefaultBase_get_DEFAULT_NUMBLOCKS_SMALL();
 ...
 */
inline jint OrgApacheXmlDtmRefDTMDefaultBase_get_NOTPROCESSED();
