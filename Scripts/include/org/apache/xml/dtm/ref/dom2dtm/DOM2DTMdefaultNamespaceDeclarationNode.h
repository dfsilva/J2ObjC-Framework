...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/dom2dtm/DOM2DTMdefaultNamespaceDeclarationNode.java
//
...
/*!
 ...
 DOM2DTM model.
 Basically, it creates a proxy node in DOM space to
...
@interface OrgApacheXmlDtmRefDom2dtmDOM2DTMdefaultNamespaceDeclarationNode : NSObject < OrgW3cDomAttr, OrgW3cDomTypeInfo > {
 @public
  ...
  NSString *prefix_, *uri_, *nodename_;
  jint handle_;
}
