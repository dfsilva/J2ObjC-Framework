...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/dom2dtm/DOM2DTM.java
//
...
@interface OrgApacheXmlDtmRefDom2dtmDOM2DTM : OrgApacheXmlDtmRefDTMDefaultBaseIterators {
 @public
  /*!
   @brief True iff the first element has been processed.
   This is used to control
 synthesis of the implied xml: namespace declaration node. 
   */
  jboolean m_processedFirstElement_;
  /*!
   @brief The node objects.
   The instance part of the handle indexes
...
/*!
 @brief Get the handle from a Node.
...
/*!
 @brief Bind an IncrementalSAXSource to this DTM.
 NOT RELEVANT for DOM2DTM, since
...
inline jboolean OrgApacheXmlDtmRefDom2dtmDOM2DTM_get_JJK_DEBUG();
...
inline jboolean OrgApacheXmlDtmRefDom2dtmDOM2DTM_get_JJK_NEWCODE();
 ...
 */
inline NSString *OrgApacheXmlDtmRefDom2dtmDOM2DTM_get_NAMESPACE_DECL_NS();
