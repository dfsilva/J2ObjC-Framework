...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/DTM.java
//
...
/*!
 ...
 It attempts to provide an interface to
...
/*!
 @brief Given an expanded name, return an ID.
 If the expanded-name does not
...
/*!
 @brief Given a node handle, return its DOM-style node name.
 This will
...
/*!
 @brief Given a node handle, return the XPath node name.
 This should be
...
/*!
 @brief Given a node handle, return its node value.
 This is mostly
...
/*!
 @brief Return the base URI of the document entity.
 If it is not known
...
/*!
 @brief Return the system identifier of the document entity.
 If
...
/*!
 ...
 either "yes" or "no".
 This property is derived from the optional
...
/*!
 @brief Return a string representing the XML version of the document.
 This
...
/*!
 @brief Append a child to "the end of the document".
 Please note that
...
/*!
 ...
 will be called.
 This will give the DTM implementation a
...
/*!
 ...
 This will allow the DTM implementation
 ...
 */
inline jint OrgApacheXmlDtmDTM_get_NULL();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_ROOT_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_ELEMENT_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_ATTRIBUTE_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_TEXT_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_CDATA_SECTION_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_ENTITY_REFERENCE_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_ENTITY_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_PROCESSING_INSTRUCTION_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_COMMENT_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_DOCUMENT_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_DOCUMENT_TYPE_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_DOCUMENT_FRAGMENT_NODE();
 ...
 */
inline jshort OrgApacheXmlDtmDTM_get_NTYPES();
