...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xpath/compiler/Compiler.java
//
...
/*!
 ...
 a Expression object.
 This class compiles the string into a sequence 
...
@interface OrgApacheXpathCompilerCompiler : OrgApacheXpathCompilerOpMap {
 @public
  /*!
   @brief The error listener where errors will be sent.
   If this is null, errors 
 and warnings will be sent to System.err.  May be null.    
   */
  id<JavaxXmlTransformErrorListener> m_errorHandler_;
  /*!
   @brief The source locator for the expression being compiled.
   May be null. 
   */
...
/*!
 @brief Compile a location path.
 The LocPathIterator itself may create
...
/*!
 @brief Compile a location path union.
 The UnionPathIterator itself may create
...
FOUNDATION_EXPORT OrgApacheXpathCompilerCompiler *new_OrgApacheXpathCompilerCompiler_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathCompilerCompiler *create_OrgApacheXpathCompilerCompiler_init();
