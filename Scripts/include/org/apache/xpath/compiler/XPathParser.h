...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xpath/compiler/XPathParser.java
//
...
/*!
 @brief Tokenizes and parses XPath expressions.
...
/*!
 ...
 errors will be sent.
 If the error listener is not set, syntax errors 
...
/*!
 ...
 in pre-fix order.
 So, for 9+7-6, instead of |+|9|-|7|6|, this needs to be
 evaluated as |-|+|9|7|6|.
...
/*!
  an Object which is either a String, a Number, a Boolean, or a vector
 of nodes.
...
/*!
 ...
 The results of the right hand side expressions
...
/*!
 @brief Insert room for operation.
 This WILL set
...
inline NSString *OrgApacheXpathCompilerXPathParser_get_CONTINUE_AFTER_FATAL_ERROR();
 ...
 */
inline jint OrgApacheXpathCompilerXPathParser_get_FILTER_MATCH_FAILED();
...
inline jint OrgApacheXpathCompilerXPathParser_get_FILTER_MATCH_PRIMARY();
...
inline jint OrgApacheXpathCompilerXPathParser_get_FILTER_MATCH_PREDICATES();
