...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xpath/operations/Variable.java
//
...
/*!
 @brief Dereference the variable, and return the reference value.
 Note that lazy 
...
/*!
 @brief Get the XSLT ElemVariable that this sub-expression references.
 In order for 
...
/*!
 @brief Set the index for the variable into the stack.
...
/*!
 ...
 This is used to determine if a proximity 
...
/*!
 @brief Set whether or not this is a global reference.
 For advanced use only.
...
inline jlong OrgApacheXpathOperationsVariable_get_serialVersionUID();
...
inline NSString *OrgApacheXpathOperationsVariable_get_PSUEDOVARNAMESPACE();
...
FOUNDATION_EXPORT OrgApacheXpathOperationsVariable *new_OrgApacheXpathOperationsVariable_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXpathOperationsVariable *create_OrgApacheXpathOperationsVariable_init();
