...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xalan/processor/ProcessorExsltFunction.java
//
...
/*!
 @brief Start an ElemExsltFunction.
 Verify that it is top level and that it has a name attribute with a
 namespace.
 */
...
inline jlong OrgApacheXalanProcessorProcessorExsltFunction_get_serialVersionUID();
...
FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorExsltFunction *new_OrgApacheXalanProcessorProcessorExsltFunction_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXalanProcessorProcessorExsltFunction *create_OrgApacheXalanProcessorProcessorExsltFunction_init();
