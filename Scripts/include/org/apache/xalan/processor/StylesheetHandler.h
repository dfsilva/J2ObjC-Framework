...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xalan/processor/StylesheetHandler.java
//
...
/*!
 @brief Push the current stylesheet being constructed.
 If no other stylesheets
...
/*!
 ...
 @param msg An key into the <code>org.apache.xalan.res.XSLTErrorResources</code>
...
/*!
 @brief Tell the user of an error, and probably throw an
 exception.
 @param msg A key into the <code>org.apache.xalan.res.XSLTErrorResources</code>
 table, that is one of the WG_ prefixed definitions.
 @param args An array of arguments for the given warning.
 @param e An error which the SAXException should wrap.
 @throws org.xml.sax.SAXException that wraps a
...
/*!
 ...
 the given URL.
 Used to test for recursive imports.
...
/*!
 @brief Push the current XSLTElementProcessor to the top of the stack.
 As a
...
/*!
 ...
 is a root stylesheet.
  internal
 */
inline jint OrgApacheXalanProcessorStylesheetHandler_get_STYPE_ROOT();
...
/*!
 ...
 is an included stylesheet.
  internal
 */
inline jint OrgApacheXalanProcessorStylesheetHandler_get_STYPE_INCLUDE();
...
/*!
 ...
 is an imported stylesheet.
  internal
 */
inline jint OrgApacheXalanProcessorStylesheetHandler_get_STYPE_IMPORT();
