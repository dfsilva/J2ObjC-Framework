...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xalan/transformer/Counter.java
//
...
@interface OrgApacheXalanTransformerCounter : NSObject {
 ...
 from.
   In other words, the count of a given node
 ...
 m_countNodesStartCount.
  ...
  /*!
   @brief The node from where the counting starts.
   This is needed to
...
/*!
 @brief Try and find a node that was previously counted.
 If found,
...
/*!
 ...
 grow to.
 */
inline jint OrgApacheXalanTransformerCounter_get_MAXCOUNTNODES();
