...
/*!
 ...
 other.
 */
+ (id<JavaLangComparable>)maxWithJavaUtilCollection:(id<JavaUtilCollection>)collection;
...
/*!
 ...
 other.
 */
+ (id<JavaLangComparable>)minWithJavaUtilCollection:(id<JavaUtilCollection>)collection;
...
FOUNDATION_EXPORT id<JavaLangComparable> JavaUtilCollections_maxWithJavaUtilCollection_(id<JavaUtilCollection> collection);
...
FOUNDATION_EXPORT id<JavaLangComparable> JavaUtilCollections_minWithJavaUtilCollection_(id<JavaUtilCollection> collection);
