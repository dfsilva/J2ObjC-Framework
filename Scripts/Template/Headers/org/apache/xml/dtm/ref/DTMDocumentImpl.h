...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/DTMDocumentImpl.java
//
...
/*!
 @brief This is the implementation of the DTM document interface.
 It receives
...
/*!
 @brief Append a child to the end of the child list of the current node.
...
/*!
 @brief Bind a IncrementalSAXSource to this DTM.
 If we discover we need nodes
...
/*!
 ...
 point.
 Assumes that the symbols (namespace URI, local name, and
...
/*!
 @brief Append a comment child at the current insertion point.
 Assumes that the
...
/*!
 @brief Terminate the element currently acting as an insertion point.
 Subsequent
...
/*!
 @brief Starting a new document.
 Perform any resets/initialization
 not already handled.
 */
- (void)appendStartDocument;

/*!
 @brief Append an Element child at the current insertion point.
 This
...
/*!
 @brief Append a text child at the current insertion point.
 Assumes that the
...
inline jbyte OrgApacheXmlDtmRefDTMDocumentImpl_get_DOCHANDLE_SHIFT();
...
inline jint OrgApacheXmlDtmRefDTMDocumentImpl_get_NODEHANDLE_MASK();
...
inline jint OrgApacheXmlDtmRefDTMDocumentImpl_get_DOCHANDLE_MASK();
