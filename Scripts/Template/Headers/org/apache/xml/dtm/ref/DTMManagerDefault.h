...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/dtm/ref/DTMManagerDefault.java
//
...
@interface OrgApacheXmlDtmRefDTMManagerDefault : OrgApacheXmlDtmDTMManager {
 ...
 access needs to be blindingly fast since it's used in node addressing.
  ...
  /*!
   @brief Map from DTM identifier numbers to offsets.
   For small DTMs with a 
...
/*!
 ...
 This convenience call adds it as the 
...
/*!
 ...
 If overflow addressing is in use, other
...
FOUNDATION_EXPORT OrgApacheXmlDtmRefDTMManagerDefault *new_OrgApacheXmlDtmRefDTMManagerDefault_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlDtmRefDTMManagerDefault *create_OrgApacheXmlDtmRefDTMManagerDefault_init();
