...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/utils/FastStringBuffer.java
//
...
/*!
 @brief Bare-bones, unsafe, fast string buffer.
 No thread-safety, no
...
@interface OrgApacheXmlUtilsFastStringBuffer : NSObject {
 ...
 to the next chunk.
   For example, if m_chunkbits is set to 15, each
 ...
 array-of-arrays.
   Note that this array, and the arrays it contains, may be
 ...
 chunk of the Chunked Array currently in use.
 ...
 FastStringBuffer's current content.
   Since m_array[][] is zero-based,
 ...
 length equals m_chunkSize, and which replaces m_array[0].
   This allows
...
inline jint OrgApacheXmlUtilsFastStringBuffer_get_DEBUG_FORCE_INIT_BITS();
...
inline jboolean OrgApacheXmlUtilsFastStringBuffer_get_DEBUG_FORCE_FIXED_CHUNKSIZE();
 ...
 */
inline jint OrgApacheXmlUtilsFastStringBuffer_get_SUPPRESS_LEADING_WS();
 ...
 */
inline jint OrgApacheXmlUtilsFastStringBuffer_get_SUPPRESS_TRAILING_WS();
...
/*!
 ...
 - seealso: #sendNormalizedSAXcharacters(org.xml.sax.ContentHandler,int,int)
 */
inline jint OrgApacheXmlUtilsFastStringBuffer_get_SUPPRESS_BOTH();
...
inline IOSCharArray *OrgApacheXmlUtilsFastStringBuffer_get_SINGLE_SPACE();
...
FOUNDATION_EXPORT OrgApacheXmlUtilsFastStringBuffer *new_OrgApacheXmlUtilsFastStringBuffer_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlUtilsFastStringBuffer *create_OrgApacheXmlUtilsFastStringBuffer_init();
