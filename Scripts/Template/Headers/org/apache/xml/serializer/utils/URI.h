...
//  source: /Users/kstanger/j2objc-push/j2objc/xalan/third_party/android/platform/external/apache-xml/src/main/java/org/apache/xml/serializer/utils/URI.java
//
...
/*!
 @brief A class to represent a Uniform Resource Identifier (URI).
 This class
...
/*!
 @brief Construct a new URI from a URI specification string.
 If the
...
/*!
 ...
 component parts.
 Each component is validated for syntax and some
...
/*!
 @brief Construct a new URI from another URI.
 All fields for this URI are
...
/*!
 @brief Append to the end of the path of this URI.
 If the current path does
...
/*!
 @brief Get the path for this URI.
 Note that the value returned is the path
...
/*!
 ...
 See RFC 2396 Section 5.2 for spec.
...
/*!
 @brief Set the fragment for this URI.
 A non-null value is valid only
...
/*!
 @brief Set the host for this URI.
 If null is passed in, the userinfo
...
/*!
 @brief Set the path for this URI.
...
/*!
 @brief Set the query string for this URI.
 A non-null value is valid only
...
/*!
 @brief Set the scheme for this URI.
 The scheme is converted to lowercase
 before it is set.
...
/*!
 @brief Set the userinfo for this URI.
 If a non-null value is passed in and
...
/*!
 @brief Get the URI as a string specification.
...
FOUNDATION_EXPORT OrgApacheXmlSerializerUtilsURI *new_OrgApacheXmlSerializerUtilsURI_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerUtilsURI *create_OrgApacheXmlSerializerUtilsURI_init();
...
FOUNDATION_EXPORT OrgApacheXmlSerializerUtilsURI_MalformedURIException *new_OrgApacheXmlSerializerUtilsURI_MalformedURIException_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheXmlSerializerUtilsURI_MalformedURIException *create_OrgApacheXmlSerializerUtilsURI_MalformedURIException_init();
