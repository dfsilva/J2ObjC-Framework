...
//  source: /Users/kstanger/j2objc-push/j2objc/junit/build_result/java/org/junit/runners/MethodSorters.java
//
...
+ (OrgJunitRunnersMethodSorters *)NAME_ASCENDING;

+ (OrgJunitRunnersMethodSorters *)JVM;

+ (OrgJunitRunnersMethodSorters *)DEFAULT;
